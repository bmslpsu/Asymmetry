function [] = Analyze_Asymmetry_Control_New(subRows,subCurrent)
%---------------------------------------------------------------------------------------------------------------------------------
% Analyze_Asymmetry_Control_New: calculates WBA in response to CW & CCW ramps, compares DAQ & VIDEO measurments
%   INPUTS:
...
for kk = 1:nTrial
    ...
    %-----------------------------------------------------------------------------------------------------------------------------
    % Load head & DAQ data %
    load([PATH  FILES{kk}],'data','t_p'); % load WBA
	%-----------------------------------------------------------------------------------------------------------------------------
