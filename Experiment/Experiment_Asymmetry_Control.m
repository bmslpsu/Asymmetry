function [] = Experiment_Asymmetry_Control(Fn,spatFreq,steps)
...
%---------------------------------------------------------------------------------------------------------------------------------
spatFreqFolder = ['E:\Experiment_Asymmetry_Control_V2\HighContrast' num2str(spatFreq)];
...
for kk = 1:n_rep*nVel
    ...
    Panel_com('send_gain_bias',[steps*gain,0,0,0]);pause(n_pause)  	% open-loop
    %-----------------------------------------------------------------------------------------------------------------------------
    ...
    disp('Saving...')
    if sign(vel) == 1
        save([spatFreqFolder 'fly_' num2str(Fn) '_trial_' num2str(kk) '_Vel_' num2str(3.75*Gain_rand) '_SpatFreq_' ...
